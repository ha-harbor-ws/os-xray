...
if [ ! -f "$BIRD_INC_DIR/communities.inc" ]; then
    printf '%s\n' '# generated by os-xray — BGP community defines' \
    ...
    echo "[OK]  $BIRD_INC_DIR/communities.inc"
else
    echo "[SKIP] $BIRD_INC_DIR/communities.inc already exists"
fi
